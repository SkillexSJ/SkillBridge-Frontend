...
export const MagicCard = ({
  ...
  }, [animateParticles, clearAllParticles, shouldDisable, enableTilt, enableMagnetism, clickEffect, glowColor, enableStars]);

  return (
    <div
      ref={cardRef}
      className={`magic-bento-card ${className} particle-container`}
      style={{

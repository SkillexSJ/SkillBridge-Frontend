...
/**
 * THIS IS A GLOWING BUTTON COMPONENT FROM Chamaac UI
 */
...
const GlowingBorderButton = ({
  ...
  return (
    <button
      className={cn(
        "glowing-border-button group relative h-[50px] cursor-pointer border-0 bg-transparent p-0 text-[20px] font-bold  outline-none",
        className,
      )}
      {...props}
    >
